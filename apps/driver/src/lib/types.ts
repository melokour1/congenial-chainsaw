// Mirrors apps/web/src/components/valet/types.ts exactly — both clients hit
// the same /api/valet/** and /api/reservations/** REST endpoints and get
// back the same JSON shapes.
