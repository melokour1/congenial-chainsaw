...
/**
 * Mirrors apps/web/src/app/api/reservations/[id]/actions/route.ts's TRANSITIONS map exactly
 * (and apps/web/src/components/valet/actionCopy.ts, the web driver portal's own copy of this
 * file) — the preview text shown in the confirm dialog MUST match what the customer actually
 * receives. Keep all three in sync.
 */
